...
st.set_page_config(page_title="Vegetable Classification",page_icon=img,layout="wide")
...
{
background-image: url("https://img.freepik.com/free-vector/hand-painted-watercolor-floral-wallpaper_52683-67104.jpg?size=626&ext=jpg&ga=GA1.1.2087154549.1663432512&semt=sph");
background-size : 100%
...
Options = st.selectbox("Select your choice",["Select Your Choice","Vegetable Classification","Sample training Images","Predictions"])
...
elif Options == "Sample training Images":
    
    a1,a2,a3,a4 = st.columns(4)
    with a1: 
        st.image("./Vegetables Dataset/Beans/24.jpeg")
    with a2: 
        st.image("./Vegetables Dataset/Beetroot/4.jpeg")  
    with a3: 
        st.image("./Vegetables Dataset/Bittergourd/4.jpg")
    with a4:
        st.image("./Vegetables Dataset/Brinjal/13.jpeg")
        
    a11,a22,a33,a44 = st.columns(4)
    with a11: 
        st.image("./Vegetables Dataset/Cabbage/26.jpeg")
    with a22: 
        st.image("./Vegetables Dataset/Capsicum/14.jpeg")
    with a33: 
        st.image("./Vegetables Dataset/Carrot/17.jpeg")
    with a44:
        st.image("./Vegetables Dataset/Cauliflower/12.jpeg")
        
    a111,a222,a333,a444 = st.columns(4)
    with a111: 
        st.image("./Vegetables Dataset/Corn/1 (4).jpeg")
    with a222: 
        st.image("./Vegetables Dataset/Drumstick/19.jpg")
    with a333: 
        st.image("./Vegetables Dataset/Garlic/2 (18).jpg")
    with a444:
         st.image("./Vegetables Dataset/Ginger/3 (7).jpg")
        
    a1111,a2222,a3333,a4444 = st.columns(4)
    with a1111: 
        st.image("./Vegetables Dataset/Lady's finger/16.jpeg")        
    with a2222: 
        st.image("./Vegetables Dataset/Lemon/4 (19).jpg")
    with a3333: 
         st.image("./Vegetables Dataset/Onion/30.jpeg")
    with a4444: 
         st.image("./Vegetables Dataset/Peas/5 (28).jpg")
              
    a11111,a22222,a33333,a44444 = st.columns(4)
    with a11111: 
        st.image("./Vegetables Dataset/Potato/9.jpeg")
    with a22222: 
        st.image("./Vegetables Dataset/Pumpkin/11.jpeg")
    with a33333: 
        st.image("./Vegetables Dataset/Radish/29.jpeg")
    with a44444: 
        st.image("./Vegetables Dataset/Tomato/18.jpeg")
